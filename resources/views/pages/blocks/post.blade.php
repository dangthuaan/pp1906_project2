...
<div class="ui-block">
    ...
    <a href="#" class="more-comments">{{ __('View more comments') }} <span>+</span></a>
    ...
    <form class="comment-form inline-items">
        ...
        <button class="btn btn-md-2 btn-primary">{{ __('Post Comment') }}</button>

        <button class="btn btn-md-2 btn-border-think c-grey btn-transparent custom-color">{{ __('Cancel') }}</button>
